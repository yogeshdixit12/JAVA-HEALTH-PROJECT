 ...
 * @author Rowdy
 */
@WebServlet(name = "expcompleteprofile", urlPatterns = {"/expcompleteprofile"})
public class expcompleteprofile extends HttpServlet {
     ...
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String t= sess.getAttribute("id").toString();
       ...
       Statement st=con.createStatement();
        String sql="update expert set quali='"+quali+"',aval='"+aval+"',price='"+fee+"'where id='"+t+"'";
