...
<body>
       ...
       try 
 {
  Class.forName("com.mysql.jdbc.Driver");
       ...
       Statement st=con.createStatement();
        String sql="Select * from appointmentt ";
 ...
 <tr class="odd gradeX">
  ...
  <th><button value="<%="Update-"+rs.getInt("id")%>" ><img src="../../images/dapmnt.jpg" data-toggle="modal" data-target="#updateappoi" height="25" width="25"></button></th>
  <th><button value="<%="delete-"+rs.getInt("id")%>" ><img src="../../images/deletee.png"  height="25" width="25"></button></th>
   <th><button value="<%="Show-"+rs.getInt("id")%>" data-toggle="modal" data-target="#Showw" ><img src="../../images/dtl.png"  height="25" width="25"></button></th>
