...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form role="form" action="http://localhost:8080/HealthProject/patent/pages/PatientMasterpage.jsp?msg=10">
          ...
          <div class="form-group">
              ...
              <div class="amount-placeholder">
                  ...
                  <span><%=request.getParameter("plan")%></span>
              </div>
          </div>
              <div class="form-group">
          ...
          <div class="zip-code-group form-group">
              ...
              <a href="http://localhost:8080/HealthProject/patent/pages/PatientMasterpage.jsp?msg=10"  button id="PayButton" class="btn btn-block btn-success submit-button" type="submit"></a>
              <span class="submit-button-lock"></span>
              <span class="align-middle">Pay :<%=request.getParameter("plan")%></span>
          </button>
      </form>
  </div>
</div>
