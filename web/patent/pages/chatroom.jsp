...
<body>
       ...
       try 
 {
  Class.forName("com.mysql.jdbc.Driver");
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="PatientMasterpage.jsp?msg=3"> Delete Appointment</a>
                                </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                 ...
                 <%
                    ...
                    case 1:
                %>
                <jsp:include page="chat2.jsp"></jsp:include>
                <%
                break;
                    case 2:
       ...
       String sql="Select * from expert where id='"+tuv+"'";
              ResultSet rs=st.executeQuery(sql);
 ...
 <jsp:include page="selectdoctor.jsp"></jsp:include>
  ...
  <div class="modal fade" id="goolmdl" role="dialog">
    ...
    <div class="modal fade" id="vew" role="dialog">
