...
<html>
    ...
    <body>
       ...
       Statement st=con.createStatement();
        String sql="update postreview set pname='"+name+"',topic='"+topp+"',coment='"+coment+"'where id='"+t+"'";
  ...
  int p=st.executeUpdate(sql);
            ...
            response.sendRedirect("http://localhost:8080/HealthProject/patent/pages/PatientMasterpage.jsp?msg=5");
        }
                        con.close();
                        st.close();
