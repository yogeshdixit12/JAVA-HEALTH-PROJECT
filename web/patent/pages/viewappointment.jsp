       ...
       try 
 {
  Class.forName("com.mysql.jdbc.Driver");
     ...
     <div class="form-group"> 
         ...
         <input type="name"class="form-control" name="patid" value="<%=rs.getString("country")%>" readonly="">
     </div>
     <div class="form-group"> 
         <label for="name" >State:</label>
         <input type="name"class="form-control" name="patid" value="<%=rs.getString("state")%>" readonly="">
     </div>
     <div class="form-group"> 
         <label for="name" >City:</label>
         <input type="name"class="form-control" name="patid" value="<%=rs.getString("city")%>" readonly="" >
     </div>
      <div class="form-group"> 
         <label for="name" >Expert Type:</label>
         <input type="name"class="form-control" name="patid" value="<%=rs.getString("exptype")%>" readonly="">
     </div>
     <div class="form-group"> 
